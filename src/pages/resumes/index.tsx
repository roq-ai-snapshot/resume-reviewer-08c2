...
import { useRoqClient, useResumeFindManyWithCount } from 'lib/roq';
...
export function ResumeListPage(props: ResumeListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useResumeFindManyWithCount({
  ...
  const handleDelete = async (id: string) => {
    setDeleteError(null);
    try {
      await roqClient.resume.delete({ where: { id } });
      await mutate();
    } catch (error) {
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'work_experience', header: 'Work Experience', accessorKey: 'work_experience' },
    { id: 'education', header: 'Education', accessorKey: 'education' },
    { id: 'skills', header: 'Skills', accessorKey: 'skills' },
    { id: 'languages', header: 'Languages', accessorKey: 'languages' },
