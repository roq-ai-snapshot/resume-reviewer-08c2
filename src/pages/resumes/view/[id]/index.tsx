...
import { useResumeFindFirst, useRoqClient } from 'lib/roq';
...
function ResumeViewPage() {
  ...
  const { data, error, isLoading } = useResumeFindFirst(queryParams, {}, { disabled: !id });
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem label="Work Experience" text={data?.work_experience} />

                <FormListItem label="Education" text={data?.education} />

                <FormListItem label="Skills" text={data?.skills} />

                <FormListItem label="Languages" text={data?.languages} />
